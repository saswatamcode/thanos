...
The compactor groups blocks using the [external_labels](https://thanos.io/tip/thanos/quick-tutorial.md/#external-labels) added by the Prometheus who produced the block. The labels must be both *unique* and *persistent* across different Prometheus instances.
