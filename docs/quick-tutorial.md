...
* *[Example Kubernetes manifest](https://github.com/thanos-io/kube-thanos/blob/main/manifests/thanos-query-deployment.yaml)*
...
* *[Example Kubernetes manifest](https://github.com/thanos-io/kube-thanos/blob/main/examples/all/manifests/thanos-compact-statefulSet.yaml)*
