...
See up to date [jsonnet mixins](https://github.com/thanos-io/thanos/blob/main/mixin/README.md) We also have example Grafana dashboards [here](../examples/dashboards/dashboards.md) and some [alerts](../examples/alerts/alerts.md) to get you started.
