...
It gathers the data needed to evaluate the query from underlying StoreAPIs. See [here](../service-discovery.md) on how to connect querier with desired StoreAPIs.
...
See [this](#partial-response) on how to control this behaviour.
